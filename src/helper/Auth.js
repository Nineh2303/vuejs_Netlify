...
export async function registerRequest(params) {
    return await new Promise((resolve, reject) => {
        const registerData = btoa(JSON.stringify(params))
        axios.defaults.headers.common['Authorization'] = "Basic " + registerData
...
export async function loginRequest(params) {
    return await new Promise((resolve, reject) => {
        const loginData = btoa(JSON.stringify(params))
        axios.defaults.headers.common['Authorization'] = "Basic " + loginData
